"""
Django settings for rhfgnyg_254 project.
...
WSGI_APPLICATION = 'rhfgnyg_254.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "rhfgnyg_254 API",
    "DESCRIPTION": "API documentation for rhfgnyg_254 App",
    "VERSION": "v1",
}
